...
from typing import Union, TYPE_CHECKING, Optional, Dict, Any, Sequence
...
class Measurement:
    ...
    def __init__(
        ...
        light_image: NDArray,
        laser_image: NDArray,
        output_directory: Union[str, Path, 'PathLike'],
        ...
        LOG.debug(f"ODMR frequencies shape: {self.odmr.raw_data.frequencies.shape}")

        # Initialize outlier mask
        LOG.debug("Initializing outlier mask.")
        self._outliers: Optional[NDArray] = np.ones(self.odmr.raw_data.shape, dtype=bool)
        ...
        self._B111: Optional[NDArray] = None
