...
|----------|-------------|-------------|
| `notebooks/01-quickstart.ipynb` | Fit and be done | Load → fit → B111 maps → save |
| `notebooks/02-exploration.ipynb` | Exploratory | Pipeline, spectrum inspection, iteration |
| `notebooks/03-extending.ipynb` | Developer | Custom model / processor / reconstructor |
...
QDMpy is distributed under the MIT License.
